...
pub fn upper_laser_phases() -> Vec<Phase<LaserMode>> {
    vec![
        ...
        Phase::new(LaserMode::Charging, 0.5),  // 15.3
        Phase::new(LaserMode::Attacking, 4.7), // 20.0
        Phase::new(LaserMode::Ready, 0.0),     // final
    ]
}
